...
function bigCrunchCheckUnlocks() {
  ...
  // Companions Tier 2 Unlocks (Post-Crunch)
  if (!player.companions.records.hasUnlockedTier2 && PlayerProgress.infinityUnlocked()) {
    player.companions.records.hasUnlockedTier2 = true;
    GameUI.notify.success("Tier 2 Companion Effects Unlocked!");
  }
}
