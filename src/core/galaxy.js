...
function galaxyReset() {
  ...
  // Check for Cookie Farm Unlock
  if (!player.companions.records.hasUnlockedFarm && player.galaxies >= 1) {
    player.companions.records.hasUnlockedFarm = true;
    GameUI.notify.success("Cookie Farm Unlocked!");
  }
